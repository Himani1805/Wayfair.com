    ...
    return (
        <VStack>
            ...
            <Flex width={"100%"} justifyContent={"center"} alignItems={"center"}>
                <Flex flexDirection={"column"} width={"100%"} alignContent={"center"} textAlign={"center"}>
                    ...
                    <Box  border={"2px solid green"}>
                        <Heading textAlign={"center"} fontWeight={"700"} fontSize={"25px"}>Unbeatable Selection</Heading>
                    </Box>
                </Flex>
                <Flex flexDirection={"column"} width={"100%"}>
                    ...
                    <Box><Heading textAlign={"center"} fontWeight={"700"} fontSize={"25px"}>Expert Customer Service</Heading></Box>
                </Flex>
                <Flex flexDirection={"column"} width={"100%"}>
                    <Box  border={"2px solid red"}>
                    ...
                    <Box><Heading textAlign={"center"} fontWeight={"700"} fontSize={"25px"} textWrap={"wrap"}>Fast & Free Shipping Over $35*</Heading></Box>
                </Flex>
                <Flex flexDirection={"column"} width={"100%"}>
                    <Box  border={"2px solid red"}>
                        <Image src="https://assets.wfcdn.com/im/31184982/resize-h64-w64%5Ecompr-r85/1711/171106371/default_name.jpg" />
                    </Box>
                    <Box><Heading textAlign={"center"} fontWeight={"700"} fontSize={"25px"}>Amazing Value Every Day</Heading></Box>
                </Flex>
            </Flex>
        </VStack>
    )
